...
(function () {
  ...
  function injectModal() {
    ...
    var html = [
      ...
      /* ── Styles ── */
      '<style>',
      '.auth-overlay{position:fixed;inset:0;background:rgba(0,0,0,0.7);backdrop-filter:blur(6px);z-index:9000;display:flex;align-items:center;justify-content:center;padding:16px;opacity:0;visibility:hidden;transition:opacity .25s var(--ease),visibility .25s}',
      '.auth-overlay.open{opacity:1;visibility:visible}',
      '.auth-box{background:var(--s1);border:1px solid var(--border);border-radius:var(--rl);padding:32px;width:100%;max-width:400px;position:relative;max-height:90vh;overflow-y:auto}',
      ...
      '.auth-social-btn{display:flex;align-items:center;justify-content:center;gap:10px;padding:12px;border-radius:var(--rm);border:none;cursor:pointer;font-family:var(--b);font-size:14px;font-weight:600;transition:opacity .2s}',
      '.auth-social-btn:hover{opacity:.85}',
      '.auth-social-btn.tg{background:var(--tg);color:#fff}',
      '.auth-social-btn.vk{background:var(--vk);color:#fff}',
      ...
      '.auth-field input{width:100%;background:var(--bg);border:1px solid var(--border);border-radius:var(--rs);padding:12px 16px;font-size:14px;font-family:var(--b);color:var(--w);outline:none;transition:border-color .2s;box-sizing:border-box}',
      ...
      '.auth-btn-primary{width:100%;background:var(--lime);color:#fff;border:none;border-radius:var(--rm);padding:14px;font-family:var(--b);font-size:14px;font-weight:700;cursor:pointer;transition:opacity .2s;margin-bottom:16px}',
      ...
      '.auth-error{background:rgba(234,58,59,0.12);color:var(--lime);border-radius:var(--rs);padding:10px 16px;font-size:13px;margin-bottom:16px}',
      '.otp-row{display:flex;gap:8px;justify-content:center;margin-bottom:16px}',
      '.otp-input{width:48px;height:48px;background:var(--bg);border:1px solid var(--border);border-radius:var(--rs);text-align:center;font-size:20px;font-weight:700;font-family:var(--m,monospace);color:var(--w);outline:none;transition:border-color .2s}',
      ...
      '.pass-req.ok{color:var(--mint)}',
      '.pass-req.ok::before{content:"✓";color:var(--mint)}',
      /* User dropdown */
      '.user-dropdown{position:absolute;top:calc(100% + 8px);right:0;background:var(--s1);border:1px solid var(--border);border-radius:var(--rm);padding:6px;min-width:160px;opacity:0;transform:translateY(-6px);pointer-events:none;transition:opacity .2s var(--ease),transform .2s var(--ease);z-index:201}',
      '.user-dropdown.open{opacity:1;transform:translateY(0);pointer-events:auto}',
      '.user-dd-item{display:flex;align-items:center;gap:8px;padding:10px 16px;border-radius:var(--rs);font-size:14px;font-weight:500;color:var(--t2);cursor:pointer;background:none;border:none;width:100%;text-decoration:none;font-family:var(--b);transition:background .2s,color .2s}',
      '.user-dd-item:hover{background:var(--s2);color:var(--w)}',
      '.user-dd-item.danger:hover{color:var(--lime);background:var(--lime10)}',
      '</style>'
    ].join('\n');
